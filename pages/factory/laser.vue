          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-4 py-3 text-center">Ստեղծման ամսաթիվ</th>
                <th scope="col" class="px-4 py-3 text-center">Ում կողմից</th>
                <th scope="col" class="px-4 py-3 text-center">
                  Ավարտի ժամկետ
                </th>
                <th scope="col" class="px-4 py-3 text-center">Նկարագրություն</th>
...
export default {
  ...
  data() {
    return {
      ...
      additionalOptions: [
        ...
        { id: 3, name: 'Նյութի առկայության բացակայություն', value: 'no_material' },
      ],
    };
  },
  computed: {
  ...
  methods: {
    ...
    async doneOrder() {
      ...
      if (this.selectedOption?.name && this.selectedOrder.status !== 'finished') {
